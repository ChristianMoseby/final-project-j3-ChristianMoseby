...
INSERT INTO Activity (ActivityId, ActivityName, ActivityTypeId, StatusId,PriceId,TimeOfDayId,TimeOfYearId,Website)
Values (4,"Dinner Theater",3,1,2,2,2,'http://murrysdp.com/');

INSERT INTO Activity (ActivityId, ActivityName, ActivityTypeId, StatusId,PriceId,TimeOfDayId,TimeOfYearId,Website)
Values (5, "River Walk", 2,1,1,3,1,'https://www.arkansas.com/attractions/detail/north-shore-riverwalk/23725');
...
INSERT INTO Activity (ActivityId, ActivityName, ActivityTypeId, StatusId,PriceId,TimeOfDayId,TimeOfYearId,Website)
Values (8,"Holiday Lights Viewing",1,3,2,2,2,'http://www.littlerockfamily.com/post/27930/places-to-see-holiday-lights-in-central-arkansas');
...
INSERT INTO Activity (ActivityId, ActivityName, ActivityTypeId, StatusId,PriceId,TimeOfDayId,TimeOfYearId,Website)
Values (11, "Indoor Ice Skating", 1,1,2,2,2,'http://www.arkansasskatium.com/');

INSERT INTO Activity (ActivityId, ActivityName, ActivityTypeId, StatusId,PriceId,TimeOfDayId,TimeOfYearId,Website)
Values (12,"Day Spa",1,2,3,1,1,'https://thespaah.com/');

INSERT INTO Activity (ActivityId, ActivityName, ActivityTypeId, StatusId,PriceId,TimeOfDayId,TimeOfYearId,Website)
Values(13,"GoKart Racing",2,1,2,1,1,'http://www.thunderroadgrandprix.com/index.html');

INSERT INTO Activity (ActivityId, ActivityName, ActivityTypeId, StatusId,PriceId,TimeOfDayId,TimeOfYearId,Website)
Values (14,"Staycation",3,3,3,3,1,'https://www.moneycrashers.com/winter-staycation-ideas-tips/');

INSERT INTO Activity (ActivityId, ActivityName, ActivityTypeId, StatusId,PriceId,TimeOfDayId,TimeOfYearId,Website)
Values (15,"Live Music" 3,1,2,2,1,'https://www.kingslivemusic.com/music');

INSERT INTO Activity (ActivityId, ActivityName, ActivityTypeId, StatusId,PriceId,TimeOfDayId,TimeOfYearId,Website)
Values (16,"Dance Class", 1,3,2,2,2,'http://www.rcdancecenter.com/curriculum_rock_city_adults.shtml');

INSERT INTO Activity (ActivityId, ActivityName, ActivityTypeId, StatusId,PriceId,TimeOfDayId,TimeOfYearId,Website)
Values (17,"Wine Tasting",1,2,2,1,1,'http://www.wiederkehrwines.com/');

INSERT INTO Activity (ActivityId, ActivityName, ActivityTypeId, StatusId,PriceId,TimeOfDayId,TimeOfYearId,Website)
Values (18, "Horse-Drawn Carriage Ride", 1,1,3,2,2,'http://www.littlerockcarriagecompany.com/#');

INSERT INTO Activity (ActivityId, ActivityName, ActivityTypeId, StatusId,PriceId,TimeOfDayId,TimeOfYearId,Website)
Values (19, "Board Game Night",3,2,1,2,2,'https://www.boardgamequest.com/top-10-couples-date-night-games/');

INSERT INTO Activity (ActivityId, ActivityName, ActivityTypeId, StatusId,PriceId,TimeOfDayId,TimeOfYearId,Website)
Values (20, "Coffee & Pastries", 3,1,2,3,2,'http://andina-cafe.com/');

INSERT INTO Activity (ActivityId, ActivityName, ActivityTypeId, StatusId,PriceId,TimeOfDayId,TimeOfYearId,Website)
Values (21, "Cooking Class", 1,2,3,3,1,'https://www.eggshellskitchencompany.com/collections/cooking-classes');

INSERT INTO Activity (ActivityId, ActivityName, ActivityTypeId, StatusId,PriceId,TimeOfDayId,TimeOfYearId,Website)
Values (22, "Couples Massage", 1,3,3,1,1,'https://rejuvenationclinic.com/day-spa/massages/');

INSERT INTO Activity (ActivityId, ActivityName, ActivityTypeId, StatusId,PriceId,TimeOfDayId,TimeOfYearId,Website)
Values (23, "Star Gazing", 1,1,1,2,1,'http://www.welovedates.com/date-ideas/outdoor-date-ideas/stargazing/');

INSERT INTO Activity (ActivityId, ActivityName, ActivityTypeId, StatusId,PriceId,TimeOfDayId,TimeOfYearId,Website)
Values (24, "Drive-in Movie", 3,1,2,2,1,'https://112driveintheatre.com/');

INSERT INTO Activity (ActivityId, ActivityName, ActivityTypeId, StatusId,PriceId,TimeOfDayId,TimeOfYearId,Website)
Values (25, "Bike Ride", 2,2,1,1,1,'http://arkansasrivertrail.org/activities/biking/');

INSERT INTO Activity (ActivityId, ActivityName, ActivityTypeId, StatusId,PriceId,TimeOfDayId,TimeOfYearId,Website)
Values (26, "Fishing",3,2,1,1,1,'https://www.arkansas.com/lake/lake-maumelle/49');

INSERT INTO Activity (ActivityId, ActivityName, ActivityTypeId, StatusId,PriceId,TimeOfDayId,TimeOfYearId,Website)
Values (27, "Horseback Riding", 3,1,2,1,1,'http://www.woffordranch.org/');
